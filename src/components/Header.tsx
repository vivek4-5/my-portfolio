...
import profilePic from '../assets/images/profile-pic.jpg'; // Assuming path is correct
...
const Header = () => {
  ...
  return (
    // --- MODIFIED HEADER ANIMATION: Fade-in ---
    <motion.header
       ...
       <nav className="container mx-auto px-4 sm:px-6 py-4 flex justify-between items-center">
         <a href="#home" onClick={(e) => handleNavClick(e, '#home')} className="logo flex items-center gap-x-3 text-2xl font-bold font-display text-primary hover:text-primary-dark transition-colors">
           <img
             ...
             width={44}
             height={44}
             className="w-11 h-11 rounded-full object-cover flex-shrink-0 border-2 border-primary/30"
             loading="lazy"
           />
